...
export default function Auth() {
    return (
        <>
            <div className="antialiased bg-gray-100 text-gray-900 font-sans">
                <div className="flex items-center h-screen w-full">
                    <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
                        ...
                        <form className="mb-4" action="/" method="post">
                            ...
                            <Link href="/admin/dashboard" className="bg-green-500 hover:bg-green-700 text-white uppercase text-sm font-semibold px-4 py-2 rounded">Login</Link>
                        </form>
